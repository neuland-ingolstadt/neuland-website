...
async function fetchDatenschutzContent() {
    try {
        const response = await fetch('https://pad.informatik.sexy/jEf0CAYVRim-4zjgJ7gaBQ/download', {
		...
		<>
            <div className="pt-20">
                ...
                {result.success ? (
                    ...
                    <FetchErrorMessage title="der Datenschutz-Information" error={result.error} />
                )}
            </div>
        </>
	)
