				...
				<div className="flex flex-col lg:flex-row relative z-10">
					...
					>
						...
						<div className="flex flex-col gap-5">
							<div className="flex items-center justify-between group/pricing">
								<span className="text-terminal-highlight font-medium group-hover/pricing:text-terminal-text transition-colors duration-200">
									Studierende:
								</span>
								<span className="text-terminal-text ml-2 font-bold font-mono text-lg group-hover/pricing:scale-105 transition-transform duration-200">
									5€ / Jahr
								</span>
							</div>
							<div className="flex items-center justify-between group/pricing">
